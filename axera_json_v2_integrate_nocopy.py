...
target_path_01 = "/data/dataset/aXcellent/manu-label/v2/xcap001/"
target_path_02 = "/data/dataset/aXcellent/manu-label/v2/xcap001_only_json/"

# 以上原因，先整合两个目录
bag_ids_source = os.listdir(source_path)
bag_ids_target = os.listdir(target_path_01)
    ...
    for sub_camera in sub_anno_folder:
        ...
        for json_name in tqdm.tqdm(os.listdir(cam_category_folder)):
            ...
            if os.path.isdir(os.path.join(source_path,bag_id)):
                ...
                output_json_path = os.path.join(target_path_01,bag_id)
            ...
            if frame_name not in frame_set:
                ...
                #load在/data/dataset/v2/xcap001_only_json下面保存的json文件
                with open(os.path.join(target_path_02,bag_date,bag_id,"ANNOTATION_manu", frame_name + '.json'), 'r') as f:
            ...
            # 在/data/dataset/v2/xcap001_only_json下保存最终有标注的帧文件
            save_path = os.path.join(target_path_02,bag_date)
